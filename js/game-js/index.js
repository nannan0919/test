...
$(function () {
    ...
    if (sessionStorage.home_of) {
        ...
        $('.home_num input').val(home_of.num);
        $('.home_num div').eq(1).text(home_of.num)
    }
    var gameId = 0;
    ...
    $('.dete').click(function () {
        event.stopPropagation();
        fangjianhao = $('.home_num>input').val();
        //设置角色的总数
        var role_num_of = 0;
        ...
        if (num_of == -1) {
            if ($('.home_num>input').val() != '' && $('.home_num>input').val() != null && $('.home_num>input').val() != undefined && $('.home_num>input').val() != 0) {
    ...
    $('.end').click(function () {
        event.stopPropagation();
        var house = $('.home_num>input').val();
        $.ajax({
            url: url + '/admin/endGame',
            data: {roomId: house, type: 1},
            type: "post",
            xhrFields: {
                withCredentials: true
            },
